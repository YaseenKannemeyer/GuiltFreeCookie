...
import jakarta.persistence.*; @Entity @Table(name = "cookies")
public class Cookie { @Id
private String cookieId; @Enumerated(EnumType.STRING)
...
protected Cookie() { }
    ...
    return "Cookie{" + "cookieId='" + cookieId + '\'' + ", category=" + category + ", description='" + description + '\'' + ", ingredients='" + ingredients + '\'' + ", allergies='" + allergies + '\'' + ", price=" + price + '}'; }
